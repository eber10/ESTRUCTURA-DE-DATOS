...
class Arbol{
    ...
    public:
        ...
        void reestructura_izq(Nodo1*& apnodo, bool& bo);
        void reestructura_der(Nodo1*& apnodo, bool& bo);
        void elimina_balanceado(Nodo1 *&apnodo, bool &bo, int dato);
};
Arbol::Arbol(){
    raiz=NULL;
}
...
void Arbol::reestructura_izq(Nodo1*& apnodo, bool& bo) {
    if (bo) {
        Nodo1* nodo1;
        Nodo1* nodo2;
        if (apnodo->fe == 0) {
...
void Arbol::reestructura_der(Nodo1*& apnodo, bool& bo) {
    if (bo) {
        Nodo1* nodo1;
        Nodo1* nodo2;
        if (apnodo->fe == 0) {
...
void Arbol::elimina_balanceado(Nodo1 *&apnodo, bool &bo, int dato) {
    if (apnodo!=NULL) {
        if (dato<apnodo->info) {
            elimina_balanceado(apnodo->izq, bo,dato);
            reestructura_izq(apnodo, bo);
        } 
        else if (dato>apnodo->info) {
            elimina_balanceado(apnodo->der, bo,dato);
            reestructura_der(apnodo, bo);
        } 
            ...
            if (otro->der ==NULL) {
                ...
                // Reemplazar la información del nodo
                apnodo->info = aux->info;
                otro = aux;

                // Reconectar el subárbol
                if (BOOL) {
                    aux1->der = aux->izq;
                    reestructura_der(apnodo->izq,bo);
                    reestructura_izq(apnodo,bo);
                } else {
                    apnodo->izq = aux->izq;
                    reestructura_izq(apnodo,bo);
...
void menu() {
    ...
    do {
        ...
        cout << "25. Eliminar nodo (arbol balanceado)" << endl;
        cout << "0. Salir" << endl;
        ...
        switch(opcion) {
            ...
            case 25:
                 if(raiz3==NULL){
                    ...
                    cout<<"ingrese dato: "; cin>>dato3;
                    arbol.elimina_balanceado(raiz3,BOL,dato3);
                }
                break;
            case 0:
